...
for (let i = 0; i < moveWords.length; i++) classifier.add(moveWords[i], 'move');
...
(async () => {
  ...
  let c = classifier.getClassifications('move');
  console.log('move: ');
  console.log(c);
...
nerManager.findEntities('I want to travel from Barcelona to Madrid',
  'en').then(entities => console.log(entities));

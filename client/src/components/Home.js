  ...
  render() {
    return(
      <div className="background">
        ...
        <h1 className="logo-header" style={{color: 'white'}}>EscapeNLP</h1>

        <div className="App-header" style={{backgroundColor: '#283942'}}>
          <div className="ui six column grid" style={{marginTop: '3%', marginBottom: '3%'}}>
            <img className="ui huge image" src={gameboard} alt="Game Board" style={{marginTop: '1%'}}/>
